...
public class Matrix {
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Ошибка ввода диапозона");
        }
        ...
        try {
            ...
            System.out.println("Неправильные аргументы, введенные в метод добавления");
        }
        ...
        try {
            ...
            System.out.println("Неправильные аргументы, введенные в метод multiply");
        }
    }
}
